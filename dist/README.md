...
|小红帽|1|<li>全屏广告-弹窗广告|
|小红书|15|<li>开屏广告<li>权限提示-通知权限<li>更新提示<li>分段广告-信息流广告<li>全屏广告-优惠券弹窗<li>评价提示-评分弹窗<li>功能类-评论区-自动展开回复<li>局部广告-你可能感兴趣的人<li>局部广告-首页信息流中推荐博主<li>局部广告-直播间右下角卡片<li>功能类-自动倍速⏩x0.75⚠️五选一<li>功能类-自动倍速⏩x1.25⚠️五选一<li>功能类-自动倍速⏩x1.5⚠️五选一<li>功能类-自动倍速⏩x2.0⚠️五选一<li>功能类-自动倍速⏩x3.0⚠️五选一|
...
|小米应用商店|9|<li>全屏广告-弹窗广告<li>全屏广告-应用外跳转<li>局部广告-卡片广告<li>功能类-忽略升级<li>权限提示-通知权限<li>局部广告-个性化推荐卡片<li>功能类-自动点击[查看全部升级]<li>功能类-移动数据更新弹窗点击继续<li>功能类-[安装新版本需要关闭应用商店]弹窗|
|小米游戏服务|1|<li>更新提示|
...
|云听|1|<li>全屏广告-首页弹窗广告|
|云蚁物联|4|<li>全屏广告<li>局部广告<li>权限提示-通知权限<li>开屏广告-启动页广告|
